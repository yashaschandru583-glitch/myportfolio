import { 
  Profile, Project, Skill, Experience, Education, Achievement, DashboardStats 
} from '../types';
...
export const initialAchievements: Achievement[] = [
  ...
  },
  {
    ...
    verificationUrl: 'https://hackathon.state-innovation.gov',
    description: 'Led a 4-person team building an IoT automated energy grid load balancer using Arduino and microservices architecture.',
    order: 2
  },
  {
    id: 'ach-3',
...
export const initialStats: DashboardStats = {
  ...
  totalExperience: initialExperience.length,
  totalEducation: initialEducation.length,
  ...
  database: {
    ...
    mode: 'Embedded High-Speed Store',
